...
def test_monai_survival_dataset():
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        try:
            ...
            x, t, e, image, dicom_path = ds[0]
            print(f"MonaiSurvivalDataset: x={x.shape}, t={t}, e={e}, image={image.shape}, dicom_path={dicom_path}")
...
def test_dataset_comparison():
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        try:
            ...
            x1, t1, e1, image1, dicom_path1 = ds1[0]
            ...
            print(f"  DICOM paths match: {dicom_path1 == dicom_path2}")
        except Exception as e:
