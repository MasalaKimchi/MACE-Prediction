...
def log_metrics(
    ...
    """Log metrics to TensorBoard and persist to CSV/JSON (rank 0 only)."""
    if rank != 0:
        return
...
def train_worker(rank, world_size, args):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if rank == 0:
            ...
            # Log metrics
            log_metrics(writer, epoch, train_loss, train_c, val_loss, val_c, td_auc, brier_dict, ibs, rank, args.log_dir)
